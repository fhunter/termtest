...
// public
volatile uint32_t ansi_parser_char_cnt = 0;

#define ICACHE_FLASH_ATTR

void ICACHE_FLASH_ATTR ansi_parser_reset(void) {
  if (cs != ansi_start) {
    cs = ansi_start;
    inside_string = false;
    //apars_reset_utf8buffer(); //FIXME
    //ansi_warn("Parser timeout, state reset"); //FIXME
  }
}
...
void ICACHE_FLASH_ATTR apars_show_context(void) {
#if DEBUG_ANSI
 ...
 */
void ICACHE_FLASH_ATTR ansi_parser(char newchar) {
